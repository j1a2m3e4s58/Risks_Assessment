...
class RiskAssessmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Risk Details', {
            # HERE ARE THE NEW SEPARATE BOXES
    ...
    def color_badge(self, rating):
        colors = {'Critical': '#d32f2f', 'Severe': '#f57c00', 'Moderate': '#fbc02d', 'Sustainable': '#388e3c'}
        color = colors.get(rating, '#777')
        return format_html(
            '<div style="background-color: {}; color: white; padding: 5px 10px; border-radius: 4px; font-weight: bold; text-align: center; width: 100px;">{}</div>',
            color, rating
        )

    def inherent_rating_colored(self, obj): return self.color_badge(obj.inherent_rating)
    inherent_rating_colored.short_description = "Inherent"
    inherent_rating_colored.admin_order_field = 'inherent_rating'

    def residual_rating_colored(self, obj): return self.color_badge(obj.residual_rating)
...
admin.site.index_title = "Risk Dashboard"

# ... (your existing code) ...

# ADMIN SITE CUSTOMIZATION
admin.site.site_header = "Bank Risk Management System"  # Top of the login page
admin.site.site_title = "Risk Admin Portal"           # Browser tab title
admin.site.index_title = "System Dashboard"           # Title on the main admin index page